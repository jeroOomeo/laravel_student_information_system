...
<section style="padding:60px 20vw;">
   ...
   <div class="col-md-12"> 
               @if(Session::get('mssg'))
                ...
                @endif
            <form class="row g-3" action="/enrollee-store" method="POST">
               @csrf
               <div class="title card-header"><h4>Enroll a Student</h4></div>
               <div class="col-md-6">
               ...
               <div class="col-md-6" >
                  ...
                  <button type="submit" class="btn btn-success" style="width:20vw;">Enroll</button>
               </div>
            </form>    
   </div>
